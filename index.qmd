...
|$\alpha_r$   |Resting RRi                              |950.00          |950.00          |900.00            |
|$\beta_r$    |Magnitude of RRi decay                   |250.00          |250.00          |300.00            |
...
|$\pi_{base}$ |Base-state [VLF, LF, HF] proportion      |[0.1, 0.2, 0.7] |[0.1, 0.2, 0.7] |[0.1, 0.45, 0.45] |
|$\pi_{pert}$ |Perturbed-state [VLF, LF, HF] proportion |[0.5, 0.3, 0.2] |[0.7, 0.2, 0.1] |[0.2, 0.5, 0.3]   |
|$c_c$        |Spectral recovery proportion             |0.80            |0.40            |1.00              |
|$b$          |Spectral structure                       |1.00            |1.00            |1.00              |
|$w$          |Proportion of structured variance        |0.90            |0.90            |0.60              |
**Table XX**. Ground-truth parameter values used in the generation of three simulation scenarios. The scenarios correspond to (A) a classic sympatho-vagal response, (B) an incomplete recovery with spectral persistence, and (C) a high noise with a stable spectrum. 
