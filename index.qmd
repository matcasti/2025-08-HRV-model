...
Further model diagnostics testing the model overall stability and reliability can be seen in the supplementary material. Prior predictive checks can be seen in Figure S1; prior sensitivity analysis in Figure S2; full posterior distributions in Figure S3; model fit to asymmetric recovery data from a different data generation processess can be seen in Figure S4 and non-gaussian distributions in Figure S5.
