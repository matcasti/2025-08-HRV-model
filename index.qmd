...
$$
\tau = \text{logit}^{-1}(\tau_{\text{logit}}) \cdot (t_{\text{max}} - t_{\text{min}}) + t_{\text{min}} \\
\delta = \text{logit}^{-1}(\delta_{\text{logit}}) \cdot (t_{\text{max}} - \tau)
$$
...
$$
c_r = \text{logit}^{-1}(c_{r, \text{logit}}) \cdot 2 \quad ; \quad c_s = \text{logit}^{-1}(c_{s, \text{logit}}) \cdot 2 \quad ; \quad c_c = \text{logit}^{-1}(c_{c, \text{logit}})
$$
...
$$
\alpha_r = \text{logit}^{-1}(\alpha_{r, \text{logit}}) \cdot 2 \cdot \text{rr\_range} + \text{rr\_min} \\
\beta_r = \text{logit}^{-1}(\beta_{r, \text{logit}}) \cdot \alpha_r
$$
...
$$
\alpha_s = \text{logit}^{-1}(\alpha_{s, \text{logit}}) \cdot \text{rr\_sd} \\ 
\beta_s = \text{logit}^{-1}(\beta_{s, \text{logit}}) \cdot \alpha_s
$$
